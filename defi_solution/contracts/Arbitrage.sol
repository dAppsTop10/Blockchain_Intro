...
contract Arbitrage {
    ...
    function getPrice_uniswap(uint256 amount) public view returns (uint256) {
    ...
    function getPrice_sushiswap(uint256 amount) public returns (uint256) {
    ...
    function _comparePrice(uint256 amount) internal view returns (Exchange) {
        ...
        function checkProfit( uint256 amountIn, uint256 higherPrice, uint256 lowerPrice) public pure returns(bool){
           bool result = _checkIfArbitrageIsProfitable(amountIn, higherPrice,lowerPrice);
            return result;
        }
    ...
    function _getPrice(address routerAddress, address sell_token, address buy_token, uint256 amount) public view returns (uint256) {
